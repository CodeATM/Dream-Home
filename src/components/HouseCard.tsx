    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {houseData.map((item, index) => (
          <div className="bg-white rounded-[10px] cursor-pointer border-[.5px] border-gray-200 " key={index}>
            ...
            <div className="px-6 pt-6 pb-4">
              ...
              <div className="space-y-3">
                <h1 className="font-bold text-[2rem] md:text-[1.5rem] tracking-wide capitalize">{item.name}</h1>
                <p className="text-gray-500 md:text-[1rem] text-xl tracking-wide md:tracking-normal capitalize">{item.address}</p>
              </div>
              <hr className="my-3"/>
              <div className="flex justify-between items-center">
                <div className="flex space-x-2 items-center text-[1.2rem] md:text-[.85rem] font-medium">
                    <FaBed className="text-[1.3rem]"/> <span className="text-gray-600">{item.bed} Beds</span>
                </div>
                <div className="flex space-x-2 items-center text-[1.2rem] md:text-[.85rem] font-medium">
                    <FaBath  className="text-[1.3rem]" /> <span className="text-gray-600">{item.bath} Bath</span>
                </div>
                <div className="flex space-x-2 items-center text-[1.2rem] md:text-[.85rem] font-medium">
                    <FaSquarespace className="text-[1.3rem]"/> <span className="text-gray-600">{item.feets} ft</span>
                </div>
              </div>
            </div>
          </div>
